...
router.post ('/user/add-task',                authController.isLogedIn, userController.postAddTask);

router.post ('/user/edit-task',               authController.isLogedIn, userController.postEditTask);
